 ...
 * @property {string} title - title to show
...
export default class yRequirement extends yBlock {
    ...
    render() {
        ...
        this.wrapper.classList.add('yRequirement');
     ...
     */
     renderSettings() {
        ...
        yRequirementIcons.forEach( tune => {
     ...
     * @param {yRequirementToolConfig} savedData
     * @return {boolean}
     */
    validate(savedData) {
        ...
        switch (event.type) {
            ...
            case 'file':
                ...
                reader.onload = (loadEvent) => {
                    this._inputContent(loadEvent.target.result);
                };
     ...
     */
     static get toolbox() {
        return {
            title: 'Requirement',
            icon: '<i class="yRequirementToolIcon"></i>'
        };
    }
